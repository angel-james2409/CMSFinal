...
public class OrderRest {
   ...
   */
  @POST
  @Path("/insertnew/{foodid}/{quantity}/{customerid}")
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.APPLICATION_JSON)
  public static String insertOrder(@PathParam("foodid") final int id, @PathParam("quantity") final int qty, @PathParam("customerid") int cid) {
    OrderFactory.insertOrder(id, qty,cid);
